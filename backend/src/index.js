...
const resolvers = {
  Query: {
    getAllDevelopers: (parent,args,context,info) => {
      return developerCrud.getAllDevelopers(parent, args);
    },
    getDeveloperById: (parent, {id}) => {
      return developerCrud.getDeveloperById(id);
    },
  ...
  Mutation: {
    ...
    createGame: (parent, args, context, info) =>
      gameCrud.createGame(parent, args, context, info),
    updateGame: (parent, args, context, info) =>
      gameCrud.updateGame(parent, args, context, info),
    deleteGame: (parent, args, context, info) => gameCrud.deleteGame(args.id),
    createGenre: (parent, args, context, info) =>
      genreCrud.createGenre(parent, args, context, info),
    signup: (parent, args, context, info) =>
      User.signup(parent, args, context, info),
    login: (parent, args, context, info) =>
      User.login(parent, args, context, info),
  },
};
